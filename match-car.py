...
def match_car(plate, car) -> CarMatch:
    ...
    make_result = ComparisonResult(compare_field(ComparisonValue.Make, plate['vin']['make'], car['vin']['make']), ComparisonValue.MAKE, plate['vin']['make'], car['car']['make'])
    model_result = ComparisonResult(compare_field(ComparisonValue.Model, plate['vin']['model'], car['vin']['model']), ComparisonValue.MODEL, plate['vin']['model'], car['car']['model'])
